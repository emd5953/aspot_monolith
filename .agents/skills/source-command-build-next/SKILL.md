---
name: "source-command-build-next"
...
1. **Pick the task.** Read `.Codex/BACKLOG.md`. Take the FIRST unchecked
...
7. **Update `.Codex/BACKLOG.md`:** move the task to `## Done` with its commit
   SHA. Commit that too.
