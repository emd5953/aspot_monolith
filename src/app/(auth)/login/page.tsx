    ...
    <div className="relative min-h-screen overflow-hidden">
      <main className="relative mx-auto flex min-h-screen max-w-md items-center justify-center px-6 py-20">
        <div className="w-full animate-fade-up">
          ...
          {/* Header */}
          <div className="mb-8">
            <p className="mb-3 text-sm font-medium text-[color:var(--ink-muted)]">Welcome back</p>
            <h1 className="font-heading text-5xl leading-[1.05] text-[color:var(--ink)]">
              Sign in to <span className="italic">aSpot</span>.
            </h1>
          </div>
          ...
          <HandDrawnCard className="p-7">
            <form className="space-y-5" onSubmit={handleLogin}>
              {message && (
                <div className="rounded-xl border border-[color:var(--accent)]/30 bg-[color:var(--accent)]/10 px-4 py-3 text-sm text-[color:var(--ink)]">
                  {message}
                </div>
              )}
              {error && (
